...
const newmanOptions = {
  collection,
  insecure: true,
  sslClientCert: fs.readFileSync("./test.crt"),
  sslClientKey: fs.readFileSync("./test.key"),
  sslClientPem: fs.readFileSync("./test.pem"), // Add this line
  sslClientPassphrase: "your_passphrase_here",
  reporters: "cli",
